...
```
1. Проверка возможности оплаты этого сотого оператора доступным способом.
2. Ввод и проверка правильности/существования номера телефона.
3. Проверка баланса откуда будут списаны средства.
4. Списание денежных средств.
5. Уведомление об одобрении или отказе и завершении транзакции.
```
